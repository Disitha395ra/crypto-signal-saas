...
export default function Footer() {
  return (
    <footer className="border-t border-gray-800 bg-gradient-to-b from-black to-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">TradeBuddy</span>
            </div>
            <p className="text-sm text-gray-400 mb-4 leading-relaxed max-w-md">
              Empowering traders with real-time market intelligence and data-driven signals. 
              Make informed decisions with precision trading signals backed by advanced algorithms.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <div>
                  <a href="mailto:support@tradebuddy.com" className="hover:text-blue-400 transition-colors">
                    support@tradebuddy.com
                  </a>
                </div>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            <p>© 2025 TradeBuddy. All rights reserved.</p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span>Built with precision for traders</span>
